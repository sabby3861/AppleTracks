...
//  AppleTracks
//
//  Created by Sanjay Kumar on 03/01/2022.
//
...
protocol ATImageCacheType: AnyObject {
...
final class ATImageCache: ATImageCacheType {
    ...
    struct Config {
        ...
        // we can change the memory here currently kept it to save till 100 MB of data only
